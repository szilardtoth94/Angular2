...
export class EditEducationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.editEducationForm = new FormGroup({
      'schoolName': new FormControl(this.education.schoolName, [Validators.minLength(2), Validators.required], null),
      'graduatedYear': new FormControl(this.education.graduatedYear, [
