...
import {DeleteConfirmationDialog} from "../pages/platform/deletedialog/delete-dialog.component";
...
import {CreateJob} from "../pages/platform/jobs/create.job/create-job.component";
...
import {ApplyDialog} from "../pages/platform/jobs/job/apply.dialog/apply-dialog.component";
import {AppliedList} from "../pages/platform/jobs/job/applied.users.list/applied-users-list.component";
